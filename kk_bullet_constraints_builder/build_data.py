...
def storeConfigDataInScene(scene):
    ...
    scene["bcb_prop_preprocTools_dis_bol"] = props.preprocTools_dis_bol
...
def getConfigDataFromScene(scene):
    ...
    if "bcb_prop_preprocTools_dis_bol" in scene.keys():
        props.preprocTools_dis_bol = scene["bcb_prop_preprocTools_dis_bol"]
