...
class bcb_props(bpy.types.PropertyGroup):
    ...
    useAccurateArea       = bool_(name="Accur. Contact Area Calculation", default=0,               description="Enables accurate contact area calculation. It is derived indirectly by dividing the calculated geometry volume divided by the element length")
