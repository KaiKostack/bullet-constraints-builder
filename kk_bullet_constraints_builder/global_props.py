...
class bcb_props(bpy.types.PropertyGroup):
    ...
    detonatorMul          = float_(name="Multiplier",             default=1, min=0.0, max=1000.0,  description="Multiplier the weakening gradient strength derived from the Detonator object space will be multiplied with")
    detonatorMax          = float_(name="Maximum",                default=1, min=0.0, max=1.0,     description="Detonator influence maximum to limit the weakening")
