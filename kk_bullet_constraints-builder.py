...
# Bevel                 | Use beveling for elements to avoid `JengaÂÂÂÂ�´� effect (uses hidden collision meshes)
# Scale                 | Apply scaling factor on elements to avoid `JengaÂÂÂÂ�´� effect (uses hidden collision meshes)
